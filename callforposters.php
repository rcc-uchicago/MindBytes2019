...
<div id="wrapper">
    ...
    <div class="main-content">
        ...
        <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-stellar-background-ratio="0.5"
                 data-bg-img="images/bg/bg11.jpg" style="background-image: url("images/bg/bg11.jpg"); background-position: 50% 0px;">
                    ...
                    <div class="row contact-wrap wow bounceInUp center pt-30">
                        <div class="col-sm-9">
                            <div class="col-sm-offset-4 alert alert-danger wow zoomIn" data-wow-duration="1s"
                                 data-wow-offset="100">
                                <h3 class="text-justify"><b>Poster submission will open <span
                                        style="background-color:yellow">SOON!</span></b></h3>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 pl-20 pt-10">
                                            <img class="pull-left pr-20" width="400" src="images/posters/item2.jpg"
                                                 alt="Specifications">
                                            <p class="text-justify">Posters should be PDF files with the dimensions <i>48”
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 pl-20 pt-10">
                                            <img class="pull-left pr-20" width="400" src="images/posters/item3.jpg"
                                                 alt="Submission">
                                            <p class="text-justify">The RCC will print all posters and display them in
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 pl-20 pt-10">
                                            ...
                                            <p class="text-justify"><b>Computing</b>
                                                ...
                                                becoming increasingly important in order to effectively use modern
                                                hardware and implement complex algorithms. The judges are interested in
                        ...
                        <!-- <div class="col-md-4 col-xs-12 col-sm-4 wow fadeInDown">
                            ...
                            <div class="row mb-15">
                                <div class="hero-buttonwrapper">
                                    <a class="hero-btn" href="gallery.php"><span>Mind Bytes 2018 poster submissions <i
