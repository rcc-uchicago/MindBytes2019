(function($) {
    ...
    RCC.initialize = {
        ...
        init: function() {
            //RCC.initialize.TM_datePicker();
            //RCC.initialize.TM_demoSwitcher();
            RCC.initialize.TM_platformDetect();
            RCC.initialize.TM_customDataAttributes();
            RCC.initialize.TM_parallaxBgInit();
            RCC.initialize.TM_resizeFullscreen();
            RCC.initialize.TM_magnificPopup_lightbox();
            RCC.initialize.TM_prettyPhoto_lightbox();
            RCC.initialize.TM_nivolightbox();
            RCC.initialize.TM_wow();
            //RCC.initialize.TM_fitVids();
            //RCC.initialize.TM_YTPlayer();
    ...
    RCC.header = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                RCC.header.TM_fullscreenMenu();
                RCC.header.TM_sidePanelReveal();
                RCC.header.TM_scroolToTopOnClick();
                RCC.header.TM_scrollToFixed();
                RCC.header.TM_topnavAnimate();
                RCC.header.TM_scrolltoTarget();
                RCC.header.TM_menuzord();
                RCC.header.TM_navLocalScorll();
                RCC.header.TM_menuCollapseOnClick();
                RCC.header.TM_homeParallaxFadeEffect();
                RCC.header.TM_topsearch_toggle();
            }, 0);
    ...
    RCC.widget = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                RCC.widget.TM_tableScheduleClickToggle();
                RCC.widget.TM_shopClickEvents();
                RCC.widget.TM_fcCalender();
                RCC.widget.TM_verticalTimeline();
                RCC.widget.TM_verticalMasonryTimeline();
                RCC.widget.TM_masonryIsotop();
                RCC.widget.TM_pieChart();
                RCC.widget.TM_progressBar();
                RCC.widget.TM_funfact();
                RCC.widget.TM_instagramFeed();
                RCC.widget.TM_jflickrfeed();
                RCC.widget.TM_accordion_toggles();
                RCC.widget.TM_tooltip();
                //RCC.widget.TM_twittie();
                RCC.widget.TM_countDownTimer();
            }, 0);
    ...
    RCC.slider = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                RCC.slider.TM_typedAnimation();
                RCC.slider.TM_flexslider();
                RCC.slider.TM_owlCarousel();
                RCC.slider.TM_maximageSlider();
                RCC.slider.TM_bxslider();
            }, 0);
        ...
        TM_flexslider: function() {
            ...
            if ($each_flex_slider.length > 0) {
                $each_flex_slider.each(function() {
                    ...
                    RCC.widget.TM_portfolioFlexSliderGalleryPopUpInit();
