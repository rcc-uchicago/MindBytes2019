...
$mail->setFrom('events@rcc.uchicago.edu', 'Mind Bytes 2018');
...
$mail->Subject = "Mind Bytes 2018 Poster Submission Information : " . $fullname . " uploaded a Poster titled ". '"'. $title_of_poster .'"';
