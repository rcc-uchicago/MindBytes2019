    ...
    <div class="header-nav-wrapper">
        <div class="container">
            <nav id="menuzord-right" class="menuzord green">
                <a class="menuzord-brand pull-left flip" href="./"><img src="images/logo_RCC.png" alt="Mind Bytes 2018 - Research Computing Expo and Symposium" class="img-responsive"></a>
