...
<head>
    ...
    <!-- Page Title -->
    <title>Call For Posters | Mind Bytes 2018 - Research Computing Expo and Symposium</title>
                ...
                <section id="callforposters">
                    ...
                    <div class="container pt-20 pb-0">
                        <div class="row contact-wrap wow bounceInUp center pt-30">
                            <div class="col-sm-9">
                                <div class="col-sm-offset-4 alert alert-danger wow zoomIn" data-wow-duration="1s" data-wow-offset="100">
                                    <h3 class="text-justify"><b>Poster submission is now <span style="background-color:yellow">CLOSED</span></b></h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 col-xs-12 wow bounceInRight" data-wow-delay="0.5s">
                                <div class="horizontal-tab">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#tab3" data-toggle="tab" aria-expanded="false"><i class="pe-7s-science"></i>Eligibility</a></li>
                                        <li class=""><a href="#tab4" data-toggle="tab" aria-expanded="false"><i class="pe-7s-rocket"></i>Specifications</a></li>
                                        <li class=""><a href="#tab5" data-toggle="tab" aria-expanded="false"><i class="pe-7s-medal"></i>Submission</a></li>
                                        <li class=""><a href="#tab6" data-toggle="tab" aria-expanded="true"><i class="pe-7s-albums"></i>Award Categories</a></li>
                                        <li class=""><a href="#tab7" data-toggle="tab" aria-expanded="true"><i class="fa fa-star-o" aria-hidden="true"></i>Prizes</a></li>
                                ...
                                <div class="tab-content pb-10" style="border: 1px solid #eeeeee; padding: 8px;">
                                    <div class="tab-pane fade active in" id="tab3">
                                        <div class="row">
                                            <div class="col-md-12 pl-20 pt-10">
                                                <img class="pull-left pr-20" width="400" src="images/posters/item1.jpg" alt="Eligibility">
                                    ...
                                    <div class="tab-pane fade" id="tab4">
                                        <div class="row">
                                            <div class="col-md-12 pl-20 pt-10">
                                                <img class="pull-left pr-20" width="400" src="images/posters/item2.jpg" alt="Specifications">
                                                <p class="text-justify">Posters should be PDF files with the dimensions <i>48” wide x 35” high</i> (landscape) and with a pixel density of <i>200 dpi</i>. To view previous years’ posters, browse below:</p>
                                                <p class="text-center">                                                    
                                                    <a href="gallery_2017.php" class="btn btn-colored btn-theme-colored btn-lg text-uppercase font-13 mt-20 hvr-glow">Mind Bytes 2017 poster submissions <i class="fa fa-file-archive-o"></i></a> 
                                                    <a href="gallery_2015.php" target="_blank" class="btn btn-dark-light btn-lg text-uppercase smooth-scroll font-13 mt-20 hvr-glow">Mind Bytes 2015 poster submissions <i class="fa fa-file-archive-o"></i></a> 
                                                    <a href="gallery_2014.php" target="_blank" class="btn btn-border btn-theme-colored btn-lg text-uppercase font-13 mt-20 hvr-glow">Mind Bytes 2014 poster submissions <i class="fa fa-file-archive-o"></i></a>
                                    ...
                                    <div class="tab-pane fade" id="tab5">
                                        <div class="row">
                                            <div class="col-md-12 pl-20 pt-10">
                                                <img class="pull-left pr-20" width="400" src="images/posters/item3.jpg" alt="Submission">
                                                <p class="text-justify">The RCC will print all posters and display them in Ida Noyes Hall during the event. Please note the RCC will print only one copy. If you make changes and resubmit a poster you may be responsible for printing the new copy.</p>
                                                <p class="text-justify"><b>Poster submission begins:</b> December 5, 2017.</p>
                                                <p class="text-justify"><b>Poster submission due date:</b> April 23, 2018 5PM CST.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pl-20 pt-10">
                                                ...
                                                <p class="text-justify"><b>Computing</b>
                                                    <br> The Computing prize will be awarded to a researcher whose poster demonstrates the best implementation and performance of the RCC's Midway compute cluster. Performance tuning and parallelization of codes are becoming increasingly important in order to effectively use modern hardware and implement complex algorithms. The judges are interested in code that runs on the greatest number of cores, the code that is best tuned to the existing hardware, and/or demonstrates the greatest performance speed-up when scaled.</p>
                                                ...
                                                <p class="text-justify"><b>Visualization</b>
                                                    <br> The Visualization prize will be given to the researcher whose poster offers the most compelling data visualization of scientific research that utilizes the RCC's resources. Contestants will be evaluated on the novelty of the technology that they implement, the level of difficulty of their visualization, and the technical use of RCC resources to produce the visualization.</p>
                                                ...
                                                <p class="text-justify"><b>The RCC Mind Bytes Judges' Choice Award</b>
                                                    <br> The judges will select a poster that is not selected for the other categories but is deserving of an award.</p>
                                    ...
                                    <div class="tab-pane fade" id="tab7">
                                        <div class="row">
                                            <div class="col-md-12 pl-20 pt-10">
                                                <p class="text-justify">Judges will evaluate each poster with respect to its field and the researcher's unique ability to use RCC computational resources in novel ways.</p>
                                                <p class="text-justify">Poster prizes: <b>iPad</b>, <b>Amazon Echo</b>, and <b>External Hard Drives</b></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-xs-12 col-sm-4 wow fadeInDown">
                                <div class="row">
                                    <div class="list-group">
                                        ...
                                        <a class="list-group-item list-group-item-info" href="#">
                                            ...
                                            <p class="list-group-item-text">December 5, 2017</p>
                                        </a>
                                        ...
                                        <a class="list-group-item list-group-item-danger" href="#">
                                            ...
                                            <p class="list-group-item-text">April 23, 2018 5PM CST</p>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-15">
                                    <div class="hero-buttonwrapper">
                                        <a class="hero-btn" href="gallery.php"><span>Mind Bytes 2018 poster submissions <i class="fa fa-file-pdf-o"></i></span></a>
                                    </div>
                                </div>
            ...
            <!--<div class="container wow fadeInRight">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="heading-line-bottom mt-0">
                            <h3 class="heading-title"><i class="fa fa-clock-o" aria-hidden="true"></i> Poster submission ends:</h3>
                        </div>
                        <div id="finalCount" class="clock flip-clock-wrapper" style="padding-left: 22%;"></div>
