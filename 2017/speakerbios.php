...
<head>
	...
	<!-- Page Title -->
	<title>Speaker Bios | Mind Bytes 2017 - Research Computing Expo and Symposium</title>
								...
								<div class="section-content">
									...
									<div class="row equal-height" id="Douglas">
										...
										<div class="col-md-8">
											...
											<p class="text-justify">Since joining SOM in 1995, Douglas Voigt has focused on complex urban plans and architectural projects. He is interested in the capacity of design to build community and connect people to one another. Voigt’s work is distinguished by a passionate appreciation for each project’s unique challenges and the need for a comprehensive and innovative response.</p>
											<p class="text-justify">Voigt balances conceptual thinking with a realistic, hands-on approach. As a designer and planner, he works closely with city leaders, institutions, and developers across the globe. Although each project has its own story, a common focus on building long-term partnerships with clients and understanding their aspirations motivates his approach to design. Over the last two decades, he has been able to unite disparate stakeholders under a cohesive vision, transforming abstract ideas into physical realities.</p>
											<p class="text-justify">Voigt is a strong advocate that every plan explore the social and natural systems within our larger urban ecology. He is committed to the research and synthesis of ideas that transcend best practices. This approach allows for the positioning of new ideas that holistically address the possibilities of the site, program, energy, water, waste, transportation, and air quality within the parameters of economic realities and urban design excellence, while scripting more sustainable models for high-performance infrastructure and livable communities. - See more at: <a href="http://www.som.com/about/leadership/douglas_voigt#sthash.oB7NSJXu.dpuf">http://www.som.com/about/leadership/douglas_voigt</a></p>
										</div>
									</div>
									<div class="row equal-height" id="Daniel">
										<div class="col-md-8">
											...
											<p class="text-justify">Daniel X. O’Neil is the Executive Director of the Smart Chicago Collaborative, a civic organization devoted to making lives better in Chicago through technology. Smart Chicago was founded by the City of Chicago, the John D. and Catherine T. MacArthur Foundation, and the Chicago Community Trust and works to apply the transformative power of technology to solve problems for the people of Chicago.</p>
											<p class="text-justify">Prior to Smart Chicago, O’Neil was a co-founder of and People Person for EveryBlock, a neighborhood news and discussion site serving 16 cities. He was responsible for uncovering new data sets through online research and working with local governments. In August 2009 EveryBlock was purchased by msnbc.com. After acquisition, O’Neil ran business development for EveryBlock, working on advertising, content partnerships, and integration with the core msnbc.com site. During this time period, O’Neil participated in the open data/ open government movement, advising governments and candidates on policy.</p>
											<p class="text-justify">Prior to EveryBlock, O’Neil spent 10 years as an Internet strategist and project manager for Streams Online Media, one of the first Web design firms in Chicago. He continued this work at Dunn Solutions Group after their purchase of Streams in 2001, with a focus on technology requirements training and the development of Web-based tools for training, e-commerce, and content management. He also created a number of sites for municipalities, including the first Web site for the Chicago Inspector General, the person in charge of rooting out corruption in Chicago city government.</p>
											<p class="text-justify">Since 2002 he’s run a number of independent Web projects, including CTA Alerts/ CTA Tweet and CityPayments.org. He’s developed dozens of Web sites for nonprofits, schools, and small businesses using easy-to-use and inexpensive tools such as weblogs, wikis, and social networking sites. In June of 2011 he was honored by the White House as a Champion of Change for Technology and Innovation.</p>
											<p>O’Neil has a degree in English and anthropology from the University of Illinois at Chicago. He writes poetry books, has written for a number of Chicago news outlets, and has the inevitable weblog. See more at <a href="http://www.derivativeworks.com">www.derivativeworks.com</a>.</p>
										</div>
										<div class="col-md-4">
											<div class="thumb">
