...
<head>
    ...
    <!-- Page Title -->
    <title>Poster Submission | Mind Bytes 2017 - Research Computing Expo and Symposium</title>
                ...
                <div class="container-fluid p-0 pt-90">
                                ...
                                <div class="section-title">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3 text-center">
                                            <h2 class="title text-white mb-0">Poster Submission</h2> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="submission">
                        <div class="row contact-wrap">
                            <div class="row">
                                <div class="col-sm-10 col-sm-offset-1 alert alert-info" role="alert">
                            ...
                            <div class="section-content text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <h2>Call at <span class="text-theme-colored">773.795.2667</span><br>Email us at <a class="text-theme-colored" href="mailto:events@rcc.uchicago.edu?Subject=Question%20regarding%20Mind%20Bytes%202017" target="_top">events@rcc.uchicago.edu</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 text-center">
                            ...
                            <h6 class="text-gray">Ida Noyes Hall<br>
									1212 E. 59th Street, Chicago, IL 60637</h6> </div>
                        <div class="col-md-9 col-md-offset-0 text-center"> <img src="images/logo_RCC.png" alt="Research Computing Center (RCC) at The University of Chicago" title="Research Computing Center (RCC) at The University of Chicago" width="45%">
                            ...
                            <ul class="social-icons flat medium list-inline">
                                <li> <a href="https://www.facebook.com/The-University-of-Chicago-Research-Computing-Center-498755713533665/" target="_blank"><i class="fa fa-facebook "></i></a> </li>
