...
<head>
	...
	<!-- Page Title -->
	<title>Posters 2015 | Mind Bytes 2017 - Research Computing Expo and Symposium
	</title>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Great Match in
												Natural Language Processing in Big Data at Scale</h4>
											</div>
											<div class="modal-body">Google n gram viewer is the most famous implementation of n gram. n gram is an essential tool for Natural Language Processing. Since the birth of the project, no one has not been able to compete with Google n gram viewer or has not even tried to do so. On this project, the author challenges Google n gram viewer in terms of # of generated n gram words building up n gram from scratch with maximum support of multicore CPUs.</div>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Robust Prior
												Analysis and Detection of Significant Change</h4>
											</div>
											<div class="modal-body">Our research is focused on analysis of future climate change and e ects of model misspecication on economic policy. In particular, the uncertainty in a climate component of linked economic-climate model a ects robust energy/consumption policies. A decision maker wants to minimize regrets over the least favorable outcome possible resulting from policy applied over a set of climate models considered.</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
											</div>
										</div>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">In Silico
												Construction of a Host/Pathogen Patient Cohort Using HPC
												Parameter Sweeps on an Agent Based Model of Sepsis</h4>
											</div>
											<div class="modal-body">Current predictive models for sepsis generally use correlative methods, and as such are limited in their individual precision due to patient heterogeneity and data sparseness. The use of computational modeling and simulation can aid in the process of contextualizing data generated by complex systems in order to describe their behavior. Towards this end, we have performed a multi-dimensional parameter sweep on a previously validated model of sepsis. Data from this parameter sweep has been used to construct an in silico cohort of patients, defined by parameters representing host health and microbial virulence, upon which further studies and simulations can be performed to both understand the septic process and design putative interventions.
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
											</div>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Halo Rendering
												via Phase Space Projection</h4>
											</div>
											<div class="modal-body">N-body simulations are often used to study how dark matter self-organizes into a complex "cosmic web" of filaments and halos. However, the discrete nature of simulations makes it difficult to study the low-density regions of the cosmic web. We developed a code that studies these regions by directly representing the continuous phase-space structure of a simulation's dark matter. This allows for the creation of ultra-high resolution density maps, like the one shown.</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Predicting
												Chicago Real Estate Market Absorption</h4>
											</div>
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title" id="myModalLabel">Integrating
												big data analysis and visualization</h4>
											</div>
											<div class="modal-body">Language is manifested at multiple, interconnected levels of structure: letters/sounds, words, phrases, etc. How can linguistic structure be learned? With the availability of large datasets (e.g., text corpora, transcribed speech collections), we develop unsupervised approaches to learning linguistic structure from unstructured data, which has important implications for both the scientific study of language and language technologies. We are constructing Linguistica 5, a software with a graphical user interface that integrates linguistic data analysis and visualization.
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
											</div>
