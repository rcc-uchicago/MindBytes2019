...
<head>
 ...
 <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon-180x180.png" />
    ...
    <script type="text/javascript"
            src="//platform-api.sharethis.com/js/sharethis.js#property=58ee69fa62683e0012c461fe&product=inline-share-buttons"></script>
...
<div id="wrapper">
    ...
    <div class="main-content">
                        ...
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="fade" data-slotamount="default"
                                ...
                                <div id="rrzm_1" class="rev_row_zone rev_row_zone_middle" style="z-index: 6;">
                                    ...
                                    <div class="tp-caption" id="slide-1-layer-14" data-x="['left','left','left','left']"
                                        ...
                                        <div class="tp-caption" id="slide-1-layer-15"
                                             ...
                                             data-type="column" data-responsive_offset="on" data-responsive="on"
                                            ...
                                            <div class="tp-caption tp-resizeme" id="slide-1-layer-1"
                                                 ...
                                                 data-responsive="on"
                                                 data-frames='[{"delay":"+890","speed":2000,"frame":"0","from":"y:50px;opacity:0;fb:10px;","to":"o:1;fb:0px;","ease":"Power4.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;fb:0;","ease":"nothing"}]'
                                                 data-textAlign="['center','center','center','center']"
                                                 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                            ...
                                            <div class="tp-caption tp-resizeme" id="slide-1-layer-4"
                                                 ...
                                                 data-whitespace="normal" data-type="text" data-basealign="slide"
                                                 data-responsive_offset="on"
                                                 data-frames='[{"delay":"+1000","split":"chars","splitdelay":0.03,"speed":500,"frame":"0","from":"sX:2;sY:2;opacity:0;fb:5px;","to":"o:1;fb:0;","ease":"Power4.easeOut"},{"delay":"wait","speed":1000,"frame":"999","to":"opacity:0;fb:10px;","ease":"Power4.easeOut"}]'
                                                 data-margintop="[50,50,50,50]" data-marginright="[0,0,0,0]"
                                                 data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]"
                                                 data-textAlign="['inherit','inherit','center','center']"
                                                 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                                                 style="z-index: 11; white-space: nowrap; letter-spacing:1px;">
                                ...
                                <a href="program.php" target="_self" class="tp-caption rev-btn tp-resizeme"
                                   id="slide-1-layer-4" data-x="['center','center','center','center']"
                                   data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                                   data-voffset="['280','240','100','83']" data-width="none" data-height="none"
                                ...
                                <div class="tp-caption rev-scroll-btn" id="slide-1-layer-16"
                                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                     data-y="['bottom','bottom','bottom','bottom']" data-voffset="['30','50','0','50']"
                                ...
                                <div class="tp-caption tp-shape tp-shapewrapper" id="slide-1-layer-17"
                                     data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                     data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                                     data-width="full" data-height="full"
                                     data-whitespace="normal" data-type="shape" data-basealign="slide"
                            ...
                            <li data-index="rs-2" data-transition="fade" data-slotamount="default"
                                ...
                                <div id="rrzm_2" class="rev_row_zone rev_row_zone_middle" style="z-index: 6;">
                                    ...
                                    <div class="tp-caption" id="slide-2-layer-14" data-x="['left','left','left','left']"
                                         data-hoffset="['100','100','100','100']"
                                         data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                                         data-width="none" data-height="none" data-whitespace="nowrap"
                                         data-type="row" data-columnbreak="2" data-basealign="slide"
                                        ...
                                        <div class="tp-caption" id="slide-2-layer-15"
                                             data-x="['left','left','left','left']"
                                             data-hoffset="['500','500','500','500']" data-y="['top','top','top','top']"
                                             data-voffset="['500','500','500','500']" data-width="none"
                                             data-height="none" data-whitespace="nowrap"
                                             data-type="column" data-responsive_offset="on" data-responsive="on"
                                             data-frames='[{"delay":"+0","speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                             data-columnwidth="100%" data-verticalalign="top" data-margintop="[0,0,0,0]"
                                            ...
                                            <div class="tp-caption tp-resizeme" id="slide-2-layer-2"
                                                 ...
                                                 data-fontsize="['110','90','100','70']"
                                                 data-lineheight="['150','100','100','70']"
                                                 data-width="['none','none','697','399']" data-height="none"
                                                 data-whitespace="['nowrap','nowrap','normal','normal']"
                                                 data-type="text" data-basealign="slide" data-responsive_offset="on"
                                                 data-frames='[{"from":"x:[105%];z:0;rX:45deg;rY:0deg;rZ:90deg;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":2000,"to":"o:1;","delay":1000,"split":"chars","splitdelay":0.05,"ease":"Power4.easeInOut"},
                                            ...
                                            <div class="tp-caption tp-resizeme Newspaper-Subtitle" id="slide-2-layer-5"
                                                 ...
                                                 data-margintop="[20,20,20,20]" data-marginright="[0,0,0,0]"
                                                 data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]"
                                                 data-textAlign="['inherit','inherit','center','center']"
                                                 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                                 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            ...
                            <li data-index="rs-3" data-transition="fade" data-slotamount="default"
                                data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                                data-easeout="default" data-masterspeed="2000" data-thumb="images/bg/DSC_6184.jpg"
                                ...
                                <div id="rrzm_3" class="rev_row_zone rev_row_zone_middle" style="z-index: 6;">
                                    ...
                                    <div class="tp-caption" id="slide-3-layer-14" data-x="['left','left','left','left']"
                                         data-hoffset="['100','100','100','100']"
                                         data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']"
                                         data-width="none" data-height="none" data-whitespace="nowrap"
                                         data-type="row" data-columnbreak="2" data-basealign="slide"
                                         data-responsive_offset="on" data-responsive="on"
                                         data-frames='[{"delay":10,"speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                         data-margintop="[100,0,0,0]" data-marginright="[0,0,0,0]"
                                         data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]"
                                         data-textAlign="['inherit','inherit','inherit','inherit']"
                                         data-paddingtop="[0,0,0,0]" data-paddingright="[100,50,40,40]"
                                         data-paddingbottom="[0,0,0,0]" data-paddingleft="[100,50,40,40]"
                                        ...
                                        <div class="tp-caption" id="slide-3-layer-15"
                                             data-x="['left','left','left','left']"
                                             data-hoffset="['100','100','100','100']" data-y="['top','top','top','top']"
                                             data-voffset="['100','100','100','100']" data-width="none"
                                             data-height="none" data-whitespace="nowrap"
                                            ...
                                            <div class="tp-caption tp-resizeme" id="slide-3-layer-1"
                                                 ...
                                                 data-voffset="['10','10','20','10']"
                                                 data-fontsize="['70','70','80','55']"
                                                 data-lineheight="['150','140','150','130']"
                                                 data-width="['none','100%','100%','100%']" data-height="none"
                                                 data-whitespace="['nowrap','nowrap','normal','normal']"
                                                 data-type="text" data-responsive_offset="off"
                                                 data-responsive="on"
            ...
            <div class="container pt-80 pl-10 pr-5">
                <div class="row mb-20 pt-10 pb-10">
                    <div class="col-md-6 mb-sm-30 center">
                        ...
                        <h3 class="title font-30 text-gray mt-0 mb-20 wow fadeInUp" data-wow-delay="1s">Join us for the
        ...
        <!--&lt;!&ndash; Keynote Speaker &ndash;&gt;-->
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Tom Blase" src="images/speakers/slider/PaulBlase.jpg"-->
        <!--class="img-fullwidth">-->
        <!--</div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="keynote.php">Paul Blase</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">CEO and Co-Founder at Speciate-->
        <!--AI</h6>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->
        ...
        <!--&lt;!&ndash; Opening Remarks &ndash;&gt;-->
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Eric Isaacs" src="images/speakers/slider/Eric_Isaacs.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="keyspeakers.php#remarks">Eric Isaacs</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Executive Vice President for-->
        ...
        <!--src="images/speakers/slider/Birali_Runesha.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="keyspeakers.php#remarks">H. Birali Runesha</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Assistant Vice President for Research-->
        <!--Computing, Director-->
        <!--of the Research Computing Center (RCC)</h6>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->

        <!--&lt;!&ndash; Lightning Talks Speakers &ndash;&gt;-->
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Sarah Cobey" src="images/speakers/slider/Sarah_Cobey.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="#">Sarah Cobey</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Assistant Professor, Department of-->
        <!--Ecology and-->
        <!--Evolution</h6>-->
        <!--<blockquote>-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Aaron Dinner"-->
        <!--src="images/speakers/slider/Aaron_Dinner.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="##Aaron">Aaron Dinner</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Professor of Chemistry and Director-->
        <!--of the James Franck-->
        <!--Institute</h6>-->
        <!--<blockquote>-->
        <!--<p><h5 class="title">Learning Mechanisms of Cellular Dynamics by Combining-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Elisabeth Moyer" src="images/speakers/slider/LizMoyer.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="##Elisabeth">Elisabeth Moyer</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Associate Professor, Atmospheric-->
        <!--Chemistry</h6>-->
        <!--<blockquote>-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Benoit Roux" src="images/speakers/slider/Benoit_Roux.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="##Benoit">Benoit Roux</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Amgen Professor of Biochemistry and-->
        <!--Molecular-->
        <!--Biology</h6>-->
        <!--<blockquote>-->
        <!--<p><h5 class="title">Predicting the Conformational Variability of Abl Tyrosine-->
        <!--Kinase using-->
        <!--Molecular Dynamics Simulations and Markov State Models</h5></p>-->
        <!--</blockquote>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Dacheng Xiu" src="images/speakers/slider/xiu.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="##Dacheng">Dacheng Xiu</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Associate Professor of Econometrics-->
        <!--and Statistics, Booth-->
        <!--School of Business</h6>-->
        <!--<blockquote>-->
        ...
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Computer Scientist, Data Science-->
        <!--Group Lead, Argonne-->
        ...
        <!--&lt;!&ndash; Panel Speakers&ndash;&gt;-->
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="James Evans" src="images/speakers/slider/JamesEvans.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="panel.php#Evans">James Evans</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Professor, Sociology; Director,-->
        <!--Knowledge Lab; Faculty-->
        <!--Director, Masters Program in Computational Social Sciences at the University of-->
        <!--Chicago</h6>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->
        ...
        <!--src="images/speakers/slider/FrancescaLazzeri.jpg"-->
        <!--class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Tom Schenk" src="images/speakers/slider/TomSchenk.jpg"-->
        <!--class="img-fullwidth">-->
        <!--</div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="panel.php#Schenk">Tom Schenk</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">Chief Data Officer at the City of-->
        <!--Chicago</h6>-->
        <!--</div>-->
        <!--</div>-->
        <!--</div>-->
        ...
        <!--<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Tom Schenk" src="images/speakers/slider/PaulSkroch.jpg"-->
        <!--class="img-fullwidth">-->
        <!--</div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="panel.php#Skroch">Paul Skroch</a></h4>-->
        <!--<h6 class="title text-gray font-14 mt-5 mb-15">VP Data Science and Platform-->
        ...
        <!--&lt;!&ndash; Other Speakers &ndash;&gt;-->
        <!--&lt;!&ndash;<div class="item col-xs-12 col-sm-12 col-md-14 mb-0">-->
        <!--<div class="team-member clearfix">-->
        <!--<div class="team-thumb"><img alt="Gregory A. Voth" src="images/speakers/slider/gregory_voth.png" class="img-fullwidth"></div>-->
        <!--<div class="overlay">-->
        <!--<div class="content text-center">-->
        <!--<h4 class="author mb-0"><a href="##Gregory">Gregory A. Voth</a></h4>-->
                ...
                <div class="schedule-tab center wow fadeInDown" data-wow-delay="0.5s">
                    <ul class="nav nav-tabs" style="margin-bottom: 20px;">
                        <li class=""><a href="http://mindbytes.uchicago.edu/2018"
                                        target="_blank">2018<span>May 8, 2018</span></a></li>
                        <li class=""><a href="http://mindbytes.uchicago.edu/2017"
                                        target="_blank">2017<span>May 2, 2017</span></a></li>
                        <li class=""><a href="http://mindbytes.uchicago.edu/2015" target="_blank">2015<span>October 27, 2015</span></a>
                        </li>
                        <li class=""><a href="http://mindbytes.uchicago.edu/2014" target="_blank">2014<span>October 28, 2014</span></a>
                        </li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-md-12 p-0">
                        <div class="featured-gallery">
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/1.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/2.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/3.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                                            <h6 class="title font-14 mt-30 mb-0">Technical demonstrations of the latest
                                                technologies.</h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/4.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/5.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/6.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                                            <h6 class="title font-14 mt-30 mb-0">Attendees listen to faculty lightning
                                                talks.</h6>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    <div class="team-thumb">
                                        <img class="img-responsive" src="images/gallery/7.jpg" alt="Mind Bytes"
                                             width="476">
                                    </div>
                                    <div class="overlay">
                                        <div class="content text-center">
                            ...
                            <div class="item">
                                <div class="team-member clearfix">
                                    ...
                                    <div class="overlay">
                                        <div class="content text-center">
                                            <h6 class="title font-14 mt-30 mb-0">Panel discussion on solving societal
