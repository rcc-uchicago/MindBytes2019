...
<body class="">
    ...
    <div id="wrapper">
        ...
        <div class="main-content">
                                ...
                                <!– *********************** –>
                                    <!– Slides to be added here –>
                                        <!– *********************** –>
                                            ...
                                            <li data-index="rs-1" data-transition="fade" data-slotamount="default"
                                                ...
                                                <div id="rrzm_1" class="rev_row_zone rev_row_zone_middle"
                                                    style="z-index: 6;">

                                                    <div class="tp-caption" id="slide-1-layer-14"
                                                        data-x="['left','left','left','left']"
                                                        data-hoffset="['100','100','100','100']"
                                                        data-y="['middle','middle','middle','middle']"
                                                        data-voffset="['0','0','0','0']" data-width="none"
                                                        data-height="none" data-whitespace="nowrap" data-type="row"
                                                        data-columnbreak="2" data-basealign="slide"
                                                        ...
                                                        <div class="tp-caption" id="slide-1-layer-15"
                                                            ...
                                                            data-type="column" data-responsive_offset="on"
                                                            data-responsive="on"
                                    ...
                                    data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[50,50,50,50]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[50,50,50,50]" style="z-index: 11; white-space: nowrap; font-size: 15px; line-height: 46px; font-weight: 700; color: rgba(255,255,255,1);font-family:Arial, Helvetica, sans-serif;border-color:rgba(255,255,255,0.25);border-style:solid;border-width:2px;border-radius:4px 4px 4px 4px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;letter-spacing:5px;cursor:pointer;">REGISTER NOW</a>-->
                                                ...
                                                <div class="tp-caption rev-scroll-btn" id="slide-1-layer-16"
                                                    ...
                                                    data-voffset="['30','50','0','50']" data-width="35" data-height="55"
                                                ...
                                                <div class="tp-caption tp-shape tp-shapewrapper" id="slide-1-layer-17"
                                                    ...
                                                    data-height="full" data-whitespace="normal" data-type="shape"
                                                    data-basealign="slide" data-responsive_offset="off"
                                                    data-responsive="on"
                                            ...
                                            <li data-index="rs-2" data-transition="fade" data-slotamount="default"
                                                ...
                                                <div id="rrzm_2" class="rev_row_zone rev_row_zone_middle"
                                                    style="z-index: 6;">

                                                    <div class="tp-caption" id="slide-2-layer-14"
                                                        data-x="['left','left','left','left']"
                                                        data-hoffset="['100','100','100','100']"
                                                        data-y="['middle','middle','middle','middle']"
                                                        data-voffset="['0','0','0','0']" data-width="none"
                                    ...
                                    data-textAlign="['left','left','left','left']" data-paddingtop="[12,12,12,12]" data-paddingright="[35,35,35,35]" data-paddingbottom="[12,12,12,12]" data-paddingleft="[35,35,35,35]" style="z-index: 11; white-space: nowrap;text-transform:left;border-color:rgba(255,255,255,0.75);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">REGISTER NOW</a>-->
                                            ...
                                            <li data-index="rs-3" data-transition="fade" data-slotamount="default"
                                                ...
                                                <div id="rrzm_3" class="rev_row_zone rev_row_zone_middle"
                                                    style="z-index: 6;">

                                                    <div class="tp-caption" id="slide-3-layer-14"
                                                        data-x="['left','left','left','left']"
                                                        data-hoffset="['100','100','100','100']"
                                                        data-y="['middle','middle','middle','middle']"
                                                        data-voffset="['0','0','0','0']" data-width="none"
            ...
            <section id="about">
                <div class="container pt-80 pl-10 pr-5">
                            ...
                            <div class="row about-posts">
                                    ...
                                    <div class="col-md-12 mb-10">
                                        <div class="entry-header">
                                            <div class="about-thumb">
                                                <img class="img-responsive img-fullwidth" src="images/about/4.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="aboutpost">
                                    <div class="col-xs-6 col-md-6 pr-5">
                                        <div class="entry-header">
                                            <div class="about-thumb">
                                                <img class="img-responsive img-fullwidth" src="images/about/5.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="aboutpost">
                                    <div class="col-xs-6 col-md-6 pl-5">
                                        <div class="entry-header">
                                            <div class="about-thumb">
                                                <img class="img-responsive img-fullwidth" src="images/about/6.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mb-20">
                        ...
                        <div class="col-md-4 mb-sm-20">
                            <div class="about-icon icon-box iconbox-border iconbox-theme-colored wow flipInX center">
                                <a class="icon icon-gray icon-bordered icon-rounded icon-border-effect effect-rounded"
                                    href="speakers.php" target="_self">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-sm-20">
                            <div class="about-icon icon-box iconbox-theme-colored wow lightSpeedIn"
                                data-wow-delay="0.5s">
                                <a class="icon icon-gray icon-bordered icon-rounded icon-border-effect effect-rounded"
                                    href="networking.php" target="_self">
                                    <i class="pe-7s-network font-48"></i></a>
                                <h4 class="title"><a href="networking.php" target="_self">Networking Opportunities</a>
                                </h4>
                            ...
                            <div class="row" id="divSpeakers">
                                ...
                                <!-- <div class="item col-xs-12 col-sm-12 col-md-14 mb-0">
                                    <div class="team-member clearfix">
                                        <div class="team-thumb"><img alt="Tom Blase"
                                                src="images/speakers/slider/PaulBlase.jpg" class="img-fullwidth">
                                        </div>
                                        <div class="overlay">
                                            <div class="content text-center">
                                                <h4 class="author mb-0"><a href="keynote.php">Paul Blase</a></h4>
                                                <h6 class="title text-gray font-14 mt-5 mb-15">CEO and Co-Founder at
                                                    Speciate
                                                    AI</h6>
                                            </div>
                                        </div>
                                ...
                                <div class="item col-xs-12 col-sm-12 col-md-14 mb-0">
                                    <div class="team-member clearfix">
                                        <div class="team-thumb"><img alt="H. Birali Runesha"
                                                src="images/speakers/slider/Birali_Runesha.jpg" class="img-fullwidth">
                                        </div>
                                        <div class="overlay">
                                            <div class="content text-center">
                                ...
                                <div class="item col-xs-12 col-sm-12 col-md-14 mb-0">
                                    <div class="team-member clearfix">
                                        <div class="team-thumb"><img alt="Stephanie Palmer"
                                                src="images/speakers/slider/Stephanie_Palmer.png" class="img-fullwidth">
                                        </div>
                                        <div class="overlay">
                                            <div class="content text-center">
                                    ...
                                    <div class="team-member clearfix">
                                        ...
                                        <div class="overlay">
                                            <div class="content text-center">
                                                ...
                                                <blockquote>
                                                    <p>
                                                        <h5 class="title">Get Organized and Share Nicely</h5>
                                                    </p>
                                                </blockquote>
                                            </div>
                                        </div>
            ...
            <!-- Section: Gallery -->
            <section id="gallery" class="divider parallax layer-overlay overlay-deep"
                data-stellar-background-ratio="0.5" data-bg-img="images/bg/mindbytes.jpg">
