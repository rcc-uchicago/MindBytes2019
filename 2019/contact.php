...
?>
    ...
    <head>
        ...
        <!-- Page Title -->
        <title>Contact Us| Mind Bytes 2019 - Research Computing Expo and Symposium</title>
                ...
                <section id="contact" class="divider bg-lighter">
                    <div class="container-fluid p-0">
                        <div class="section-content">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 bg-img-center bg-img-cover p-0 wow rollIn" data-wow-delay="1.0s">								
									<!-- Google Map HTML Codes -->
									<!--<div data-address="Ida Noyes Hall 1212 E. 59th Street Chicago, IL 60637 United States" data-popupstring-id="#popupstring1" class="map-canvas autoload-map" data-mapstyle="default" data-height="600" data-latlng="41.788211,-87.595580" data-title="Ida Noyes Hall 1212 E. 59th Street Chicago, IL 60637 United States"
                                        data-zoom="16" data-marker="images/map.png">
                                    </div>
									...
									<!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDFej_32vT-Qcha_QYe-Xa-ZVNIn2Ajt1E&callback=initMap"></script>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="contact-wrapper wow fadeInUp" data-wow-duration="1.2s" data-wow-offset="10">
